...
We are pleased to announce the birth of a new project in the world of communications, introducing: [Wazo](http://www.wazo.community).
...
* Extendable using plugins in most services
* Reusable using our [API](http://api.wazo.community)
...
We will release Wazo 16.16 very shortly, in early December 2016. We will provide a simple procedure to upgrade your XiVO installation to Wazo, we want to keep the transition as smooth as possible. Keep in touch!
